...
import MenuSetting from "./SubMenu/MenuSetting";

const Profile = ({ name, info, image }) => {
    const [setting,setSetting]  = useState(false)

    const buttonSettingOption = () => {
        if (!setting) {
            setSetting(<MenuSetting setSetting={setSetting}/>)
        }else{
            setSetting(false)
        }
    }
